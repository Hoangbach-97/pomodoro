...
<head>
    ...
    <title>{{ config('app.name', 'Pomodorosmart') }}</title>
                            ...
                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('register') }}"><b
                                        style="color:black">Register</b> <span class="fa fa-code-fork"></span></a>
